...
local hover_kind_hl = {
  alias = "GloseHoverKindAlias",
  method = "GloseHoverKindFunction",
  ["function"] = "GloseHoverKindFunction",
  constructor = "GloseHoverKindFunction",
  property = "GloseHoverKindProperty",
  index = "GloseHoverKindProperty",
  variable = "GloseHoverKindVariable",
  parameter = "GloseHoverKindVariable",
  const = "GloseHoverKindVariable",
  let = "GloseHoverKindVariable",
  class = "GloseHoverKindType",
  interface = "GloseHoverKindType",
  ["type alias"] = "GloseHoverKindType",
  type = "GloseHoverKindType",
  enum = "GloseHoverKindEnum",
  ["enum member"] = "GloseHoverKindEnum",
  namespace = "GloseHoverKindModule",
  module = "GloseHoverKindModule",
  import = "GloseHoverKindModule",
  export = "GloseHoverKindModule",
  field = "GloseHoverKindProperty",
  global = "GloseHoverKindVariable",
  ["local"] = "GloseHoverKindVariable",
}
...
local function get_hover_kind_icon(kind)
  ...
  local hl = hover_kind_hl[lower] or "GloseHoverKind"
  return icon, hl
end

function HoverPanel:apply_extmarks(_, lines)
  local ns = vim.api.nvim_create_namespace "glose_hover"
  ...
  local tag_icons = require("glose.parsers").get_all_tags()
