...
local render_mod = require "glose.core.inlay_hint.render"
local debounce = require "glose.util.debounce"

local ns = vim.api.nvim_create_namespace "glose_inlay_hint"
local augroup = vim.api.nvim_create_augroup("glose_inlay_hint", { clear = true })
