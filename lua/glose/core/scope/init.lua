...
local biscuit = require "glose.core.scope.biscuit"
local debounce = require "glose.util.debounce"

local ns = vim.api.nvim_create_namespace "glose_scope"
local augroup = vim.api.nvim_create_augroup("glose_scope", { clear = true })
...
local function get_cfg()
  return require("glose.config").get().scope
end
