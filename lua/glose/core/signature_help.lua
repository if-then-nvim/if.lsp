...
function SignatureHelpPanel:open_win(lines)
  ...
  vim.api.nvim_set_option_value(
    "winhighlight",
    "Normal:GloseNormal,FloatBorder:GloseBorder,SignColumn:GloseNormal",
    { win = self.win }
  )
...
function SignatureHelpPanel:apply_extmarks(_, lines)
  local ns = vim.api.nvim_create_namespace "glose_signature_help"
...
function M.setup_auto()
  ...
  pcall(vim.api.nvim_del_augroup_by_name, "glose_signature_auto")
  pcall(vim.api.nvim_del_augroup_by_name, "glose_signature_attach")

  local trigger_group = vim.api.nvim_create_augroup("glose_signature_auto", { clear = true })

  vim.api.nvim_create_autocmd("LspAttach", {
    group = vim.api.nvim_create_augroup("glose_signature_attach", { clear = true }),
