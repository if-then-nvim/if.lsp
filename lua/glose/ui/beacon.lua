...
function M.beacon(bufnr, lnum, col)
  local cfg = require("glose.config").get().definition.beacon
  ...
  local ns = vim.api.nvim_create_namespace "glose_beacon"
  vim.api.nvim_buf_set_extmark(buf, ns, 0, 0, { end_col = width, hl_group = "GloseBeacon" })
