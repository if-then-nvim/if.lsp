...
local diff = require "glose.ui.diff"
...
function PreviewManager:update(idx)
  ...
  local ns_name = "glose_" .. panel.name
...
function PreviewManager:clear_preview()
  ...
  vim.bo[panel.buf].modifiable = false
  vim.api.nvim_buf_clear_namespace(panel.buf, vim.api.nvim_create_namespace "glose_diff_syntax", 0, -1)
