...
local hover_kind_hl = {
  alias = "IfLspHoverKindAlias",
  method = "IfLspHoverKindFunction",
  ["function"] = "IfLspHoverKindFunction",
  constructor = "IfLspHoverKindFunction",
  property = "IfLspHoverKindProperty",
  index = "IfLspHoverKindProperty",
  variable = "IfLspHoverKindVariable",
  parameter = "IfLspHoverKindVariable",
  const = "IfLspHoverKindVariable",
  let = "IfLspHoverKindVariable",
  class = "IfLspHoverKindType",
  interface = "IfLspHoverKindType",
  ["type alias"] = "IfLspHoverKindType",
  type = "IfLspHoverKindType",
  enum = "IfLspHoverKindEnum",
  ["enum member"] = "IfLspHoverKindEnum",
  namespace = "IfLspHoverKindModule",
  module = "IfLspHoverKindModule",
  import = "IfLspHoverKindModule",
  export = "IfLspHoverKindModule",
  field = "IfLspHoverKindProperty",
  global = "IfLspHoverKindVariable",
  ["local"] = "IfLspHoverKindVariable",
}
...
local function get_hover_kind_icon(kind)
  ...
  local hl = hover_kind_hl[lower] or "IfLspHoverKind"
  return icon, hl
end

function HoverPanel:apply_extmarks(_, lines)
  local ns = vim.api.nvim_create_namespace "iflsp_hover"
  ...
  local tag_icons = require("if.lsp.parsers").get_all_tags()
...
function M.hover()
  ...
  lsp.request_first(source_bufnr, "textDocument/hover", function(client)
    ...
    vim.notify("IfLsp: No hover information available", vim.log.levels.INFO)
  end)
end
