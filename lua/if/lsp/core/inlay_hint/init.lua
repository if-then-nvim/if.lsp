...
local render_mod = require "if.lsp.core.inlay_hint.render"
local debounce = require "if.lsp.util.debounce"

local ns = vim.api.nvim_create_namespace "iflsp_inlay_hint"
local augroup = vim.api.nvim_create_augroup("iflsp_inlay_hint", { clear = true })
