...
local data = require "if.lsp.core.scope.data"
local biscuit = require "if.lsp.core.scope.biscuit"
local debounce = require "if.lsp.util.debounce"

local ns = vim.api.nvim_create_namespace "iflsp_scope"
local augroup = vim.api.nvim_create_augroup("iflsp_scope", { clear = true })
...
local function get_cfg()
  return require("if.lsp.config").get().scope
end
