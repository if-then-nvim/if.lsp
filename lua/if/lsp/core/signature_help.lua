...
function SignatureHelpPanel:apply_extmarks(_, lines)
  local ns = vim.api.nvim_create_namespace "iflsp_signature_help"
...
function M.setup_auto()
  ...
  pcall(vim.api.nvim_del_augroup_by_name, "iflsp_signature_auto")
  pcall(vim.api.nvim_del_augroup_by_name, "iflsp_signature_attach")

  local trigger_group = vim.api.nvim_create_augroup("iflsp_signature_auto", { clear = true })

  vim.api.nvim_create_autocmd("LspAttach", {
    group = vim.api.nvim_create_augroup("iflsp_signature_attach", { clear = true }),
